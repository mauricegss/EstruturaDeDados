...
int busca_linear(int vet[], int a, int b, int x)
{
    if(a<=b){
        if(vet[a]==x)
        {
            return busca_linear(vet,a+1,b,x);
        } else {
            return a;
        }
    } else {
...
int busca_binaria(int vet[], int a, int b, int x)
{
    if(a<=b)
    {
        ...
        {
            return busca_binaria(vet, m+1,b,x);
        }
        else
        {
            return busca_binaria(vet, a,m-1,x);
        }
    } else {
        return -1;
    }
...
int main()
{
	...
	ShellSort(vet, 0, 999);
        ...
        printf("Tempo gasto: %.4g ms.", tempo2);
